...
# Define the file path and worksheet names
# file_path <- "Highlands.xlsx"
# worksheet_names <- c("LPx", "HPx", "Ol", "Ilm", "Pl", "CrSp", "MgSp", "Kfs")  # Replace with actual worksheet names
# output_file <- "Highlands_impute.xlsx"
